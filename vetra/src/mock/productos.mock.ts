...
// Dcto base
const descuentos: IDiscount[] = [
  {
    id: 1,
    fechaInicio: new Date("2025-06-01"),
    fechaCierre: new Date("2025-06-10"),
    descuento: 10
  },
  {
    id: 2,
    fechaInicio: new Date("2025-06-05"),
    fechaCierre: new Date("2025-06-15"),
    descuento: 20
  },
  {
    id: 3,
    fechaInicio: new Date("2025-06-07"),
    fechaCierre: new Date("2025-06-14"),
    descuento: 15
  },
  {
    id: 4,
    fechaInicio: new Date("2025-06-03"),
    fechaCierre: new Date("2025-06-13"),
    descuento: 25
  },
  {
    id: 5,
    fechaInicio: new Date("2025-06-02"),
    fechaCierre: new Date("2025-06-12"),
    descuento: 5
  }
];
...
export const productosMock: IProduct[] = [
  // ZAPATILLAS (20 modelos)
  {
    ...
    image: "https://acdn-us.mitiendanube.com/stores/005/244/864/products/jag_jhe-c-9359-101_1-26acca8915cbf8942b17344377265369-1024-1024.png",
    color: ["Negro", "Blanco"],
    marca: "Vetra Sport",
    descuento_id: descuentos[0].descuento
  },
{
  id: 2,
  nombre: "Urban Flex",
  ...
  talles: [talles[0], talles[1], talles[2],],
  color: ["Azul", "Gris"],
  image: "https://acdn-us.mitiendanube.com/stores/001/498/432/products/s10759-12_1-c9f66c98a005f68e6a17139949381236-640-0.jpg",
  marca: "Vetra Urban",
  descuento_id: descuentos[1].descuento
},]
/*{
  id: "zap-003",
